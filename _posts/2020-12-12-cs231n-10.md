...
CS231n강의는 1~16강으로 구성되어 있으며 이번 포스트는 **Lecture 10 - Recurrent Neural Networks** 에 대해 다루겠습니다.
...
이전 CNN 모델의 연장선으로 10강은 RNN에 대해 다룹니다. RNN은 시계열 데이터, 문자열 데이터, 주식, 비디오 데이터 등 다양한 데이터에 활용할 수 있습니다.
