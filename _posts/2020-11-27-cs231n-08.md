---
title: "[CS231n] Lecture 8 - Deep Learning Software"
date: 2020-11-20
categories: dl
toc: true
toc_sticky: true
...
CS231n강의는 1~16강으로 구성되어 있으며 이번 포스트는 **Lecture 8 - Deep Learning Software** 에 대해 다루겠습니다.
...
지난 7강까지 딥러닝의 구조에 대해 알아보았습니다.

이번 8강에서는 파이토치와 텐서플로우 등의 딥러닝 프레임워크에 대해 알아보겠습니다.
...
일반적인 딥러닝 프레임워크 구조에 대해 알아보겠습니다.

아래 슬라이드의 Computational Graph를 사용하는 대표적인 프레임워크는 텐서플로우로 상대적으로 low level의 프레임워크입니다.

<br/>

![](https://github.com/Jihyun22/Jihyun22.github.io/blob/master/_posts/images/cs231n-8/61.jpg?raw=true)

케라스는 텐서플로우를 백엔드로 하여 computational graph를 자동으로 생성합니다.

우선 레이어의 시퀀스로 모델을 구현한 후 optimaizer을 구현한 뒤 model을 컴파일하면 그래프가 생성되며 fit 명령어로 학습 과정이 진행됩니다.
...
딥러닝 프레임워크의 아키텍쳐를 살펴보며 gpu 실행 환경에 대해 다루었습니다.

다음 강의에서는 CNN의 구조에 대해 다루겠습니다.
