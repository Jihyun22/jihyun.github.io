---
title: "[데이콘 온도추정 대회] 데이터셋 구조 살펴보기"
toc: true
widgets:
  - type: toc
    position: right
...
cover: /img/cover/tf_cover.png
thumbnail: /img/thumbnail/dacon_th.png
categories:
  - Machine-Learning
  - Dacon
tags:
...
- [AI프렌즈 시즌1 온도 추정 경진대회](https://dacon.io/competitions/official/235584/overview/)
...
[![데이터설명](https://jihyun22.github.io/img/tf/2.JPG)](https://youtu.be/ukzaKsnKfXw)
...
![train.head 결과값](https://jihyun22.github.io/img/tf/3.JPG)
...
![train.tail 결과값](https://jihyun22.github.io/img/tf/4.JPG)
...
![test.head 결과값](https://jihyun22.github.io/img/tf/4.JPG)
...
이러한 데이터의 특징을 바탕으로, 다음 포스트에서는 모델 구성을 위한 기본 아이디어를 고민하겠습니다.
...
>
> [Dacon 관련 포스트 더보기](https://jihyun22.github.io/categories/Machine-Learning/Dacon/)
>
> [Dacon 온도추정 대회 관련 포스트 더보기](https://jihyun22.github.io/tags/temperature-forecast/)
